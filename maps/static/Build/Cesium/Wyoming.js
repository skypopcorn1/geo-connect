...
dataSource.loadUrl('../static/Build/Cesium/test.json').then(function() {
...
viewer.dataSources.add(dataSource);
//Sandcastle_End
    console.log('viewer.datasources.add method has been called.');
}
...
// var theUrl = '../static/Build/Cesium/test.json';
//
...
//     var sampleObject = xmlHttp.responseText;
//
//     fs.writeFile("..static/Build/Cesium/test.json", JSON.stringify(sampleObject), (err) => {
//         if (err) {
//             console.error(err);
//             return;
//         };
...
// var viewer = new Cesium.Viewer('cesiumContainer');
// var theUrl = "http://localhost:8000/api/?format=json";
//
// function httpGet(theUrl)
// {
//     var xmlHttp = new XMLHttpRequest();
...
// console.log(dataSource[0].x);
//
// var entity = dataSource.entities.add({
//    position : Cesium.Cartesian3.fromDegrees(dataSource["x"], 2, 0),
//
// });
//
// viewer.dataSources.add(dataSource);
...
// <script>
//
// var obj = JSON.parse('[{"x":666650.0,"y":6236650.0,"z":99998.0,"x_origin":666400.0,"y_origin":6236400.0,"x_extent":214200.0,"y_extent":320000.0,"x_mesh_size":500.0,"y_mesh_size":500.0,"rotation":90.0,"description":"IllawarraCM_SF","last_updated":"2017-08-26T13:42:54.486502Z"},{"x":654654.0,"y":654.0,"z":46654.0,"x_origin":654.0,"y_origin":654.0,"x_extent":321.0,"y_extent":321.0,"x_mesh_size":10.0,"y_mesh_size":10.0,"rotation":90.0,"description":"IllawarraCM_SF","last_updated":"2017-08-26T13:43:19.988150Z"}]');
// for (var i = 0, len = obj.length; i < len; ++i) {
//      document.getElementById("demo").innerHTML = obj[1].x
//      var student = obj[i];
//      $("<div id=\"" + student.x + "\">" + student.y + " (" + student.x + " - " + student.description + ")</div>");
//  }
//
// </script>
//
